...
-- CS2 Bomb Timer (api.lua-centric)
-- Uses helpers from api.lua wherever possible; CurTime() wrapper
-- Clean, editable UI with resolution scaling

-- =====================
-- Requirements
-- =====================
-- Ensure api.lua is loaded before this script.
-- It should provide: LocalPlayer(), Game(), CurTime(), C4(), etc.
